...
static void prefs_add_entry(plist_t* pl) /*{{{*/
{
    ...
    plist_dict_insert_item(
        dict, "XAuthName",
        plist_new_string(
            "\";mode_cfg on;proposal { authentication_method xauth_psk_client; hash_algorithm "
            "sha1; encryption_algorithm aes 256; lifetime time 3600 sec; dh_group 2; } include "
            "\"/private/var/preferences/SystemConfiguration/com.apple.ipsec.plist\"; proposal {"));
