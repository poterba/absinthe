...
std::unique_ptr<Report::arm_state> Report::parse_state(const std::string& description)
{
    ...
    num = sscanf(
        line, "%*[ ]r0: 0x%08x%*[ ]r1: 0x%08x%*[ ]r2: 0x%08x%*[ ]r3: 0x%08x", &state->r0,
    ...
    num = sscanf(
        line, "%*[ ]r4: 0x%08x%*[ ]r5: 0x%08x%*[ ]r6: 0x%08x%*[ ]r7: 0x%08x", &state->r4,
    ...
    num = sscanf(
        line, "%*[ ]r8: 0x%08x%*[ ]r9: 0x%08x%*[ ]r10: 0x%08x%*[ ]r11: 0x%08x", &state->r8,
    ...
    num = sscanf(
        line, "%*[ ]ip: 0x%08x%*[ ]sp: 0x%08x%*[ ]lr: 0x%08x%*[ ]pc: 0x%08x", &state->ip,
