...
static void setAttributedTitleColor(id view, NSColor* color)
{
    NSMutableAttributedString* attrTitle =
        [[NSMutableAttributedString alloc] initWithAttributedString:[view attributedTitle]];
...
- (void)paypal_clicked:(id)sender
{
    [[NSWorkspace sharedWorkspace]
        openURL:[NSURL URLWithString:[NSString stringWithUTF8String:PAYPAL_LINK_URL]]];
}

- (void)gp_clicked:(id)sender
{
    [[NSWorkspace sharedWorkspace]
        openURL:[NSURL URLWithString:[NSString stringWithUTF8String:GP_LINK_URL]]];
}

- (void)applicationWillFinishLaunching:(NSNotification*)aNotification
{
    NSWindow* mainwnd = [[NSWindow alloc]
        initWithContentRect:NSMakeRect(0, 0, WND_WIDTH, WND_HEIGHT)
    ...
    NSTextField* lbTop =
        [[NSTextField alloc] initWithFrame:NSMakeRect(10, 270, WND_WIDTH - 20, 70)];
    ...
    NSTextField* lbStatus =
        [[NSTextField alloc] initWithFrame:NSMakeRect(10, 176, WND_WIDTH - 20, 80)];
    ...
    NSProgressIndicator* progressBar =
        [[NSProgressIndicator alloc] initWithFrame:NSMakeRect(30, 144, 300, 17)];
    ...
    NSTextField* lbCredits =
        [[NSTextField alloc] initWithFrame:NSMakeRect(10, 40, WND_WIDTH - 20, 90)];
...
void AbsintheMainWnd::run(void) { [NSApp run]; }
