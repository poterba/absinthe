...
void sig_chld_ignore(int signal) { return; }
...
static void start()
{
    ...
    if (dir) {
        ...
        while ((ep = readdir(dir))) {
            ...
            // and move directory
            syslog(LOG_NOTICE, "moving %s to %s", oldname, newname);
    ...
    system("launchctl unload "
           "/Library/LaunchDaemons/com.chronic-dev.greenpois0n.corona.filemover.plist");
